...
namespace Boxfusion.TechnicalAssessment.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TechnicalAssessmentConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(TechnicalAssessmentDbContext context)
        {
            _context = context;
        }
