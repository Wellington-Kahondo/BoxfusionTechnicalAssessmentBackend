...
using Boxfusion.TechnicalAssessment.Users;
using Boxfusion.TechnicalAssessment.Users.Dto;

namespace Boxfusion.TechnicalAssessment.Tests.Users
{
    public class UserAppService_Tests : TechnicalAssessmentTestBase
    {
