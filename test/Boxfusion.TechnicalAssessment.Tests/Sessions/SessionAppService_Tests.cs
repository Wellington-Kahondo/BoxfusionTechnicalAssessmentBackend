...
using Shouldly;
using Xunit;
using Boxfusion.TechnicalAssessment.Sessions;

namespace Boxfusion.TechnicalAssessment.Tests.Sessions
{
    public class SessionAppService_Tests : TechnicalAssessmentTestBase
    {
