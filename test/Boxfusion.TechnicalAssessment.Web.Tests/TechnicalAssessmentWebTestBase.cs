...
{
    public abstract class TechnicalAssessmentWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TechnicalAssessmentWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TechnicalAssessmentWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TechnicalAssessmentDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TechnicalAssessmentDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TechnicalAssessmentDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TechnicalAssessmentDbContext, Task<T>> func)
        {
            T result;
